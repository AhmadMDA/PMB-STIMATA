...
var KTModalNewAddress = (function () {
    ...
    return {
        init: function () {
            (r = document.querySelector("#kt_pelatihan")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_form_pelatihan")),
                (t = document.getElementById("kt_pelatihan_submit")),
                (e = document.getElementById("kt_pelatihan_cancel")),
