...
var KTModalNewAddress = (function () {
    ...
    return {
        init: function () {
            (r = document.querySelector("#kt_pengajuan")) &&
                ((i = new bootstrap.Modal(r)),
                (o = document.querySelector("#kt_form_pengajuan")),
                (t = document.getElementById("kt_pengajuan_submit")),
                (e = document.getElementById("kt_pengajuan_cancel")),
