                                        ...
                                        axios
                                            ...
                                            .then(function (e) {
                                                if (e) {
                                                    ...
                                                    e && (location.href = e);
                                                } else Swal.fire({ text: "Maaf, email atau password anda salah, silahkan coba lagi", icon: "error", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn btn-primary" } });
                                            })
                                            .catch(function (t) {
                                                Swal.fire({
                                                    text: "Maaf, terjadi kesalahan sistem, silahkan coba lagi!",
