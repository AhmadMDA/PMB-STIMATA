    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
            ...
            <div class="app-navbar flex-shrink-0">
                <!--begin::Search-->
                <div class="app-navbar-item align-items-stretch ms-lg-3 ms-1">
                    <!--begin::Search-->
                    <div id="kt_header_search" class="header-search d-flex align-items-stretch"
                        ...
                        <div data-kt-search-element="content"
                            ...
                            <div data-kt-search-element="wrapper">
                                ...
                                <div data-kt-search-element="results" class="d-none">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-350px">
                                        ...
                                        <!--begin::Item-->
                                        <a href="#"
                                            class="d-flex text-hover-primary align-items-center mb-5 text-gray-900">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ asset('keen/assets/media/avatars/300-6.jpg') }}"alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ asset('keen/assets/media/avatars/300-2.jpg') }}"
                                                    alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ asset('keen/assets/media/avatars/300-9.jpg') }}"
                                                    alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ asset('keen/assets/media/avatars/300-14.jpg') }}"
                                                    alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <a href="#"
                                            ...
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-40px me-4">
                                                <img src="{{ asset('keen/assets/media/avatars/300-11.jpg') }}"
                                                    alt="" />
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ asset('keen/assets/media/svg/brand-logos/volicity-9.svg') }}"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ asset('keen/assets/media/svg/brand-logos/tvit.svg') }}"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ asset('keen/assets/media/svg/misc/infography.svg') }}"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ asset('keen/assets/media/svg/brand-logos/leaf.svg') }}"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                        ...
                                        <a href="#"
                                            ...
                                            <div class="symbol symbol-40px me-4">
                                                <span class="symbol-label bg-light">
                                                    <img class="w-20px h-20px"
                                                        src="{{ asset('keen/assets/media/svg/brand-logos/tower.svg') }}"
                                                        alt="" />
                                                </span>
                                            </div>
                                            <!--end::Symbol-->
                                ...
                                <div class="mb-5" data-kt-search-element="main">
                                    ...
                                    <div class="scroll-y mh-200px mh-lg-325px">
                                        ...
                                        <div class="d-flex align-items-center mb-5">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="#"
                                                    class="fs-6 text-hover-primary fw-semibold text-gray-800">"Kept API
                                                    Project Meeting</a>
                            ...
                            <form data-kt-search-element="advanced-options-form" class="d-none pt-1">
                                <!--begin::Heading-->
                                <h3 class="fw-semibold mb-7 text-gray-900">Advanced Search</h3>
                                <!--end::Heading-->
                                <!--begin::Input group-->
                                <div class="mb-5">
                            ...
                            <form data-kt-search-element="preferences" class="d-none pt-1">
                                <!--begin::Heading-->
                                <h3 class="fw-semibold mb-7 text-gray-900">Search Preferences</h3>
                                <!--end::Heading-->
                                <!--begin::Input group-->
                ...
                <div class="app-navbar-item ms-lg-3 ms-1">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true"
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                            style="background-image:url({{ asset('keen/assets/media/misc/menu-header-bg.jpg')}})">
                            <!--begin::Title-->
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="px-4 text-center">
                                        <img class="mw-100 mh-200px" alt="image"
                                            src="{{ asset('keen/assets/media/illustrations/sketchy-1/1.png') }}"
                                            alt="" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                ...
                                <div class="scroll-y mh-325px my-5 px-8">
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-hover-primary fw-semibold text-gray-800">Search query</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-hover-primary fw-semibold text-gray-800">System update</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-hover-primary fw-semibold text-gray-800">Refund process</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                    ...
                                    <div class="d-flex flex-stack py-4">
                                        ...
                                        <div class="d-flex align-items-center me-2">
                                            ...
                                            <!--begin::Title-->
                                            <a href="#"
                                                class="text-hover-primary fw-semibold text-gray-800">Mail tasks</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Section-->
                                        <!--begin::Label-->
                ...
                <div class="app-navbar-item ms-lg-3 ms-1">
                    ...
                    <div class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-35px h-35px w-md-40px h-md-40px"
                        ...
                        <span class="symbol symbol-20px">
                            <img class="rounded" src="{{ asset('keen/assets/media/flags/united-states.svg') }}"
                                alt="" />
                        </span>
                    </div>
                    <!--begin::User account menu-->
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-semibold fs-6 w-175px py-4"
                        data-kt-menu="true">
                        <!--begin::Menu item-->
                        <div class="menu-item px-3">
                            <a href="account/settings.html" class="menu-link d-flex active px-5">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1"
                                        src="{{ asset('keen/assets/media/flags/united-states.svg') }}"
                                        alt="" />
                                </span>English</a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-3">
                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1" src="{{ asset('keen/assets/media/flags/spain.svg') }}"
                                        alt="" />
                                </span>Spanish</a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-3">
                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1" src="{{ asset('keen/assets/media/flags/germany.svg') }}"
                                        alt="" />
                                </span>German</a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-3">
                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1" src="{{ asset('keen/assets/media/flags/japan.svg') }}"
                                        alt="" />
                                </span>Japanese</a>
                        </div>
                        <!--end::Menu item-->
                        ...
                        <div class="menu-item px-3">
                            <a href="account/settings.html" class="menu-link d-flex px-5">
                                <span class="symbol symbol-20px me-4">
                                    <img class="rounded-1" src="{{ asset('keen/assets/media/flags/france.svg') }}"
                                        alt="" />
                                </span>French</a>
                        </div>
                        <!--end::Menu item-->
                ...
                <!--end::Theme mode-->
                <!--begin::User menu-->
                <div class="app-navbar-item ms-lg-3 ms-1 ms-2" id="kt_header_user_menu_toggle">
                    <!--begin::Menu wrapper-->
                    <div class="symbol symbol-35px symbol-md-40px cursor-pointer"
                        data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent"
                        data-kt-menu-placement="bottom-end">
                        <img src="{{ asset('keen/assets/media/avatars/300-3.jpg') }}" alt="" />
                    </div>
                    <!--begin::User account menu-->
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-275px py-4"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ asset('keen/assets/media/avatars/300-3.jpg') }}"
                                        alt="" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                        ...
                        <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            data-kt-menu-placement="left-start" data-kt-menu-offset="-15px, 0">
                            {{-- <a href="#" class="menu-link px-5">
                                <a class="menu-title position-relative">Language
                                </a>
                                        class="fs-8 bg-light position-absolute translate-middle-y top-50 end-0 rounded px-3 py-2">
                                        English
                                        <img class="w-15px h-15px rounded-1 ms-2"
                                            src="
                                            {{ asset('keen/
                                                                                                                                                                                                                            assets/media/flags/united-states.svg" alt="" /></
                                                                                                                                                                                                                            ') }}"
                                            alt="" />
                            </a> --}}
                            <!--begin::Menu sub-->
                                ...
                                <div class="menu-item px-3">
                                    <a href="account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="
                                            {{ asset('keen/assets/media/flags/spain.svg') }}"
                                                alt="" />
                                        </span>Spanish</a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <div class="menu-item px-3">
                                    <a href="account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="
                                            {{ asset('keen/assets/media/flags/united-states.svg') }}"
                                                alt="" />
                                        </span>German</a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <div class="menu-item px-3">
                                    <a href="account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="
                                            {{ asset('keen/assets/media/flags/japan.svg') }}"
                                                alt="" />
                                        </span>Japanese</a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <div class="menu-item px-3">
                                    <a href="account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="
                                            {{ asset('keen/assets/media/flags/france.svg') }}"
                                                alt="" />
                                        </span>French</a>
                                </div>
                                <!--end::Menu item-->
