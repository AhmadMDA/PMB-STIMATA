...
<div class="content">
    ...
    <div class="tabs">
        ...
        <a href="http://127.0.0.1:8000/Bukti-Pembayaran"class="active">Bukti Pembayaran</a>
    ...
    <div class="upload-section">
        ...
        <div class="upload-container">
            <label for="file-upload" class="file-label">
                Pilih File Portofolio (Max 5 mb)
            </label>
            <input type="file" id="file-upload" class="file-upload" accept=".jpg, .jpeg, .png">
            <input type="text" value="Bukti_Pembayaran-Max.jpg" readonly class="file-display">
        </div>
        <p class="file-info">Tipe file: png, jpg, jpeg</p>
        <div class="next-button-container">
            <a href="http://127.0.0.1:8000/Dokumen-Pelengkap" class="next-button">Next</a>
        </div>
        </div>
    </div>
