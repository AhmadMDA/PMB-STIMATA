...
@section('content')
    ...
    <div class="card card-flush mb-9" id="kt_user_profile_panel">
        ...
        <div class="card-header rounded-top bgi-size-cover h-200px"
            style="background-position: 100% 50%; background-image:url('{{ asset('images/bg-profil.png') }}')"></div>
        <!--end::Hero nav-->
        <!--begin::Body-->
            ...
            <div class="m-0">
                ...
                <div class="d-flex flex-stack align-items-end pb-4 mt-n19">
                    <div class="symbol symbol-125px symbol-lg-150px symbol-fixed position-relative mt-n3">
                        <img src="{{ asset('images/stock.jpg') }}" alt="image" class="border border-white border-4"
                ...
                <div class="d-flex flex-stack flex-wrap align-items-end">
                    ...
                    <!--begin::Actions-->
                    <div class="d-flex">
                        <a href="/pengajuan/rpl" class="btn-sm btn-purple me-3" id="kt_drawer_chat_toggle">Rekognisi
                            Pembelajaran Lampau</a>
    ...
    <!-- Navigasi -->
    <x-horizontal-navbar :items="$navItems" active-background-color="bg-white" active-text-color="text-black"
    ...
    <div id="content1" class="content-section">
        <x-card :header="'Ubah Data Pribadi'">
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="form_datapribadi" class="form" enctype="multipart/form-data">
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper w-125px h-125px"
                                    style="background-image:url('{{ asset('images/stock-image.png') }}')"></div>
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <select name="kelamin" aria-label="Pilih Jenis Kelamin" data-control="select2"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 fv-row">
                                    <input type="text" name="tempatlahir"
                                        class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                                        placeholder="Tempat Lahir" value="Hasselt, Belgia" />
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col-lg-6 fv-row">
                                    <div class="input-group mb-5">
                                        <input class="form-control form-control-solid" name="tanggal_lahir"
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <select name="agama" aria-label="Pilih Agama" data-control="select2"
                                data-placeholder="Pilih Agama.." class="form-select form-select-solid form-select-lg">
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <select name="negara" aria-label="Pilih Kewarganegaraan" data-control="select2"
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="tel" name="ktp" class="form-control form-control-lg form-control-solid"
                                placeholder="Nomor KTP" value="35097*********" />
                        </div>
                        <!--end::Col-->
                    </div>
                    <!-- Alamat -->
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="alamat" class="form-control form-control-lg form-control-solid"
                                placeholder="Alamat" value="Jln. Merdeka No 45, Belanda" />
                        </div>
                        <!--end::Col-->
                    </div>
                    <!-- Email-->
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="email" name="" class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="tel" name="telepon" class="form-control form-control-lg form-control-solid"
                                placeholder="Nomor Telepon" value="082214909909" />
                        </div>
                        <!--end::Col-->
                    </div>
                    <!-- WhatsApp -->
                    <div class="row mb-6">
                        ...
                        <label class="col-lg-4 col-form-label fw-semibold fs-6">
                            ...
                            <span class="ms-1" data-bs-toggle="tooltip"
                                title="Nomor whatsapp boleh berbeda dengan telepon">
                                <i class="ki-duotone ki-information-5 text-gray-500 fs-6">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                                    <span class="path3"></span>
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="tel" name="whatsapp" class="form-control form-control-lg form-control-solid"
                                placeholder="Nomor WhatsApp" value="082214909909" />
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        ...
                        <button type="submit" class="btn btn-primary"
                            id="submit_datapribadi">Simpan</button>
                    </div>
                    <!--end::Actions-->
                </form>
                <!--end::Form-->
                    ...
                    <form id="kt_signin_change_email" class="form" novalidate="novalidate">
                        <div class="row mb-6">
                            <div class="col-lg-6 mb-4 mb-lg-0">
                                <div class="fv-row mb-0">
                                    <label for="emailaddress" class="form-label fs-6 fw-bold mb-3">Masukkan Email
                                        Baru</label>
                                    <input type="email" class="form-control form-control-lg form-control-solid"
                                        id="emailaddress" placeholder="Email Address" name="emailaddress"
                                        value="hatelando@gmail.com" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="fv-row mb-0">
                                    <label for="confirmemailpassword" class="form-label fs-6 fw-bold mb-3">Konfirmasi
                                        Password</label>
                        ...
                        <div class="d-flex">
                            ...
                            <button id="kt_signin_cancel" type="button"
                                class="btn btn-color-gray-500 btn-active-light-primary px-6">Batal</button>
                        </div>
                    </form>
                    <!--end::Form-->
                </div>
                ...
                <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                    ...
                    <form id="kt_signin_change_password" class="form" novalidate="novalidate">
                        <div class="row mb-1">
                            <div class="col-lg-4">
                                <div class="fv-row mb-0">
                                    <label for="currentpassword" class="form-label fs-6 fw-bold mb-3">Password
                                        Sekarang</label>
                                    <input type="password" class="form-control form-control-lg form-control-solid"
    ...
    <div id="content2" class="content-section d-none">
        <x-card :header="'Ubah Latar Belakang pendidikan'">
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="form_pendidikan" class="form">
                    <!-- Nama Sekolah -->
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="sekolah"
                                class="form-control form-control-lg form-control-solid" placeholder="Sekolah"
                                value="Negeri 5 Hasselt" />
                        </div>
                    </div>
                    <!-- Tahun Lulus -->
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <select name="lulus-sekolah" aria-label="Pilih Tahun Lulus" data-control="select2"
                                data-placeholder="Pilih Tahun Lulus.."
                                class="form-select form-select-solid form-select-lg">
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="asal-pt" class="form-control form-control-lg form-control-solid"
                                placeholder="Asal Perguruan Tinggi" value="Institut Teknologi Belanda" />
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="prodi-sebelumnya"
                                class="form-control form-control-lg form-control-solid"
                                placeholder="Program Studi Sebelumnya" value="S1 - Teknik Informatika" />
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <button type="reset" class="btn btn-light btn-active-light-primary me-2">Batal</button>
                        <button type="submit" class="btn btn-primary"
                            id="submit_pendidikan">Simpan</button>
                    </div>
                    <!--end::Actions-->
                </form>
                <!--end::Form-->
    ...
    <div id="content3" class="content-section d-none">
        <x-card :header="'Ubah Data Orang Tua / Wali'">
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="form_orangtua" class="form">
                    <!-- Nama Ayah -->
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="ayah" class="form-control form-control-lg form-control-solid"
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="ibu" class="form-control form-control-lg form-control-solid"
                                placeholder="Nama Ibu" value="Sophie Kumpen" />
                        </div>
                        <!--end::Col-->
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Penerima Kartu Perlindungan Sosial
                            (KPS)</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <select name="kps" aria-label="Pilih Penerimaan Kartu" data-control="select2"
                                data-placeholder="Pilih Penerimaan Kartu.."
                                class="form-select form-select-solid form-select-lg">
                    ...
                    <div class="row mb-6">
                        ...
                        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Jenis Tinggal Selama
                            Kuliah</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <select name="jtinggal" aria-label="Pilih Jenis Tinggal" data-control="select2"
                                data-placeholder="Pilih Jenis Tinggal.."
                                class="form-select form-select-solid form-select-lg">
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <button type="reset" class="btn btn-light btn-active-light-primary me-2">Batal</button>
                        <button type="submit" class="btn btn-primary"
                            id="submit_orangtua">Simpan</button>
                    </div>
                    <!--end::Actions-->
                </form>
                <!--end::Form-->
    ...
    <div id="content4" class="content-section d-none">
        <x-card :header="'Ubah Data Lain'">
            <div id="kt_account_settings_profile_details" class="collapse show">
                <!--begin::Form-->
                <form id="form_datalain" class="form">
                    <!-- Upload Foto KTP -->
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                ...
                                <div class="image-input-wrapper"
                                    style="width:323px; height: 204px; background-image:url('{{ asset('images/ktp.png') }}')">
                                </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-8 fv-row">
                            <select name="transportasi" aria-label="Pilih Alat Transportasi" data-control="select2"
                                data-placeholder="Pilih Alat Transportasi.."
                                class="form-select form-select-solid form-select-lg">
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        <button type="reset" class="btn btn-light btn-active-light-primary me-2">Batal</button>
                        <button type="submit" class="btn btn-primary"
                            id="submit_datalain">Simpan</button>
                    </div>
                    <!--end::Actions-->
                </form>
                <!--end::Form-->
    ...
    <script>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('input[name="foto_ktp"]').val(data.foto_ktp);
                $('select[name="transportasi"]').val(data.alat_transportasi);
            },
        });

        // Update Profil
        $("#form_datapribadi").on("submit", function (e) {
            e.preventDefault();

            const userId = "{{ Auth::user()->id }}";
            const formData = {
                pas_foto: $('input[name="foto"]').val(),
                nama_lengkap: $('input[name="nama"]').val(),
                jenis_kelamin: $('select[name="kelamin"]').val(),
                tmp_lahir: $('input[name="tempatlahir"]').val(),
                tgl_lahir: $('input[name="tanggal_lahir"]').val(),
                agama: $('select[name="agama"]').val(),
                kewarganegaraan: $('select[name="negara"]').val(),
                no_ktp: $('input[name="ktp"]').val(),
                alamat: $('input[name="alamat"]').val(),
                email: $('input[name="email"]').val(),
                no_hp: $('input[name="telepon"]').val(),
                no_wa: $('input[name="whatsapp"]').val(),
            };
        ...
        $("#form_pendidikan").on("submit", function (e) {
            ...
            const userId = "{{ Auth::user()->id }}";
            const formData = {
                asal_sma: $('input[name="sekolah"]').val(),
                tahun_lulus: $('select[name="lulus-sekolah"]').val(),
                asal_pt: $('input[name="asal-pt"]').val(),
                prodi_pt: $('input[name="prodi-sebelumnya"]').val(),
            };
        ...
        $("#form_datalain").on("submit", function (e) {
            e.preventDefault();

            const userId = "{{ Auth::user()->id }}";
            const formData = {
                foto_ktp: $('input[name="foto_ktp"]').val(),
                alat_transportasi: $('select[name="transportasi"]').val(),
            };
