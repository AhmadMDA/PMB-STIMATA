...
<html lang="en">
	...
	<head>
<base href="../../" />
		<title>404 Not Found | STIMATA</title>
		<meta charset="utf-8" />
	...
	<body id="kt_body" class="app-blank app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Page bg image-->
			<style>body { background-image: url('{{ asset('images/bg.png') }}'); } [data-bs-theme="dark"] body { background-image: url('assets/media/auth/bg13-dark.jpg'); }</style>
			<!--end::Page bg image-->
				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							<!--begin::Title-->
							<h1 class="fw-bolder fs-2hx text-gray-900 mb-4">Ups!</h1>
							<!--end::Title-->
							<!--begin::Text-->
							<div class="fw-semibold fs-6 text-gray-500 mb-7">Kita tidak bisa menemukan halaman itu.</div>
							<!--end::Text-->
							<!--begin::Illustration-->
							<div class="mb-3">
								<img src="{{ asset('images/404.png') }}" class="mw-100 mh-300px theme-light-show" alt="" />
								<img src="{{ asset('images/404-dark.png') }}" class="mw-100 mh-300px theme-dark-show" alt="" />
							</div>
							<!--end::Illustration-->
							<!--begin::Link-->
							<div class="mb-0">
