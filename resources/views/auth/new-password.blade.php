...
<html lang="en">
						...
						<div class="w-lg-500px p-10">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_new_password_form" data-kt-redirect-url="/login" action="#">
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-gray-900 fw-bolder mb-3">Atur Kata Sandi Baru</h1>
									<!--end::Title-->
									<!--begin::Link-->
									<div class="text-gray-500 fw-semibold fs-6">Sudah mereset password anda ? 
									<a href="/login" class="link-primary fw-bold">Masuk</a></div>
									<!--end::Link-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group-->
								...
								<div class="fv-row mb-8">
									<label class="form-check form-check-inline">
										...
										<span class="form-check-label fw-semibold text-gray-700 fs-6 ms-1">Saya Setuju dengan 
										<a class="ms-1 link-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_scrollable_2">Ketentuan</a>.</span>
									</label>
								</div>
								<!--end::Input group=-->
								<!--begin::Action-->
    ...
    <script src="{{ asset('keen/assets/js/custom/authentication/reset-password/new-password.js') }}"></script>
