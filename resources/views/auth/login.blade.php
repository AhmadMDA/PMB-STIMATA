...
<body id="kt_body" class="app-blank app-blank">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center bg-primary">
                ...
                <div class="d-flex flex-column flex-center p-6 p-lg-10 w-100">
                    <!--begin::Image-->
                    <img class="d-none d-lg-block mx-auto w-150px w-lg-175px w-xl-200px mb-10 mb-lg-20"
                        src="https://stimata.ac.id/media/2023/01/logo-stimata.jpg" alt="" />
                    <!--end::Image-->
                    <!--begin::Title-->
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        <!--begin::Form-->
                        <form method="POST" class="form w-100" action="/login">
                            @csrf
                            <!--begin::Heading-->
                            ...
                            <div class="d-grid mb-10">
                                <button type="submit" id="kt_sign_in_submit" class="btn btn-primary">
                                    ...
                                    <span class="indicator-progress">Sedang masuk...
    ...
    @if (session('success'))
        <script>
            ...
            toastr.success("Silahkan Login menggunakan akun anda", "Registrasi Akun berhasil");
        </script>
    @endif
    ...
    <script src="{{ asset('keen/assets/js/custom/authentication/sign-in/general.js') }}"></script>
